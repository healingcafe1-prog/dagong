...
app.get('/', async (c) => {
  ...
  if (isMobileDevice) {
    try {
            ...
            <div class="container mx-auto px-4 text-center">
              <div class="max-w-3xl mx-auto">
                ...
                <h1 class="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                  생산자와 소비자,<br class="md:hidden" /> 함께 만드는 천년의 가치
                </h1>
      ...
      console.error('모바일 홈 페이지 로드 오류:', error)
      return c.render(
        <div id="app">
