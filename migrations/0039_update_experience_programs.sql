...
-- 1. 임시 테이블 생성 (horse_riding 타입 추가)
CREATE TABLE experiences_new (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  title TEXT NOT NULL,
  region_id INTEGER,
  producer_id INTEGER,
  experience_type TEXT NOT NULL CHECK(experience_type IN ('tea_experience', 'craft_workshop', 'farm_tour', 'workshop_visit', 'horse_riding')),
  description TEXT,
  duration TEXT,
