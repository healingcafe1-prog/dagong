...
-- 4. 명상의 역사와 정의 삭제 (id: 23)
DELETE FROM education_curriculum WHERE id = 23;

-- 5. 호흡명상 내용 업데이트 (id: 30)
...
-- 1. 명상의 종류와 실천 (id: 24) - intermediate, 150분
-- 2. 명상의 역사 (id: 25) - beginner, 90분
-- 3. 명상의 정의와 원리 (id: 26) - beginner, 60분
-- 4. 호흡 명상 (id: 30) - beginner, 45분
-- 5. 마음챙김 명상 (id: 31) - intermediate, 60분
-- 6. 차 명상 (id: 32) - intermediate, 90분
-- 7. 요가와 명상 (id: 33) - intermediate, 75분
