...
-- 2. 카테고리 데이터 (27개)
INSERT OR IGNORE INTO categories (id, name, parent_id, type, description, display_order) VALUES
-- 차 카테고리 (7개)
...
-- 선물 카테고리 (4개)
(12, '명절 선물세트', NULL, 'gift_set', '명절 특별 선물', 1),
(13, '기념일 선물세트', NULL, 'gift_set', '기념일용 선물', 2),
(14, '기업 선물세트', NULL, 'gift_set', '기업용 선물', 3),
(15, '맞춤 선물세트', NULL, 'gift_set', '맞춤형 선물', 4),
...
-- 3. 지역 데이터 (17개)
INSERT OR IGNORE INTO regions (id, name, type, description, display_order) VALUES
-- 차 산지 (8개)
(1, '제주도', 'tea', '제주 녹차의 고장', 0),
(2, '하동', 'tea', '전통 하동 녹차', 0),
(3, '김해', 'tea', '김해 차 문화', 0),
(4, '광양', 'tea', '광양 녹차', 0),
(5, '보성', 'tea', '보성 녹차', 0),
...
-- 공예 산지 (9개)
(9, '경기 광주', 'craft', '경기 광주 공예', 1),
(11, '여주', 'craft', '여주 도자기', 2),
(10, '이천', 'craft', '이천 도자기', 3),
(17, '진천', 'craft', '진천 공예', 4),
(12, '청주', 'craft', '청주 공예', 5),
(15, '문경', 'craft', '문경 도자기', 6),
(16, '김해', 'craft', '김해 공예', 7),
(14, '강진', 'craft', '강진 도자기', 8),
(13, '부안', 'craft', '부안 공예', 9);


-- 4. 월별 이벤트 데이터 (28개)
INSERT OR IGNORE INTO events (id, title, description, event_type, discount_rate, banner_image, start_date, end_date, is_active, month, is_recurring, priority) VALUES
-- 1월 (2개)
