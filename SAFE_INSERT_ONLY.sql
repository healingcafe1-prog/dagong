...
-- 6. education_categories 테이블 데이터 삽입 (6개 카테고리)
INSERT OR IGNORE INTO education_categories (id, name, description, icon, display_order, created_at) VALUES
...
-- 7. education_curriculum 테이블 데이터 삽입 (30개 교육과정)
INSERT OR IGNORE INTO education_curriculum (id, category_id, title, description, duration, price, max_students, schedule, instructor, curriculum_detail, difficulty, prerequisites, certificate, image, created_at) VALUES
...
-- 8. events 테이블 데이터 삽입 (27개 이벤트, 1월~12월)
INSERT OR IGNORE INTO events (id, title, description, event_type, discount_rate, banner_image, start_date, end_date, is_active, created_at, month, is_recurring, priority) VALUES
